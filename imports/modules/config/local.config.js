module.exports = {
    ...
    SMS: {
        ...
        authToken: process.env.TWILIO_AUTHTOK || "b242112c256f92a81ad597b129c97ae4"
    },
    BLOCKCLUSTER: {
    ...
    PUBNUB: {
        pubKey: process.env.PUBNUB_PUBKEY ||
            "pub-c-f4bd0466-069e-4bd2-94cf-b299dc02f92a",
        subKey: process.env.PUBNUB_SUBKEY ||
            "sub-c-b6590186-f6e1-11e8-b35b-72ed2feff2dd",
        secret: process.env.PUBNUB_SECRET ||
    ...
    PUSH_NOTIF: {
        FCM: {
            ...
            SERVER_KEY: process.env.PUSH_FCM_SERVER_KEY ||
