...
let strings = new LocalizedStrings({
    en: {
        ...
        umr: "Unable to make the request!",
        srs: "Sos request success!",
        ...
        SOS: "SOS",
        "Put some feedback of the ride": "Put some feedback of the ride",
        "unable to cancel request": "unable to cancel request",
        "failed to update the review": "failed to update the review",
        "Review submitted, Thank you.": "Review submitted, Thank you.",
        "Live Location Hustle": "Live Location Hustle",
        "Link Copied": "Link Copied",
        "unable to fetch driver details": "unable to fetch driver details",
        Accept: "Accept",
        "Ride Requests": "Ride Requests",
        "currently no requests nearby": "currently no requests nearby",
        messageFroDriverNotif: "Message From Driver",
        "You have a new message": "You have a new message",
        "Unknown error occurred": "Unknown error occurred",
        "Unable to start the ride!": "Unable to start the ride!",
        "Unable to Finish the ride!": "Unable to Finish the ride!",
        "Ride completed": "Ride completed",
        "Unable to mark payment for the ride!":
            "Unable to mark payment for the ride!",
        "Payment Marked": "Payment Marked",
        "failed to update the review": "failed to update the review",
        "Review submitted, Thank you.": "Review submitted, Thank you.",
        ...
        "Navigate to Rider": "Navigate to Rider",
        "Start Ride": "Start Ride",
        "Navigate to drop": "Navigate to drop",
