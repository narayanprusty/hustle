    ...
    Meteor.call("emailVerification", queries.key, (err, res) => {
      if(res){
        this.setState({
          ...
          disabled: true,
          showMessage: true,
          resultMessage: <p>Congrats...!!! Your email has been verified. You would be automatically redirected to login page in 5 seconds. Else <a href="/login"> Click here </a></p>
        });
        setTimeout(() => {
