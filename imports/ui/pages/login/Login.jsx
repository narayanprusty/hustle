        ...
        <div className="padding">
          ...
          <div className='row'>
            <div className='col col-60'>
              <button onClick={() => {this.setState({toRegister: true})}} className="button button-block button-light activated"><i className="fa fa-key" aria-hidden="true"></i> Forgot Password </button>
            </div>
            <div className='col col-40'>
              <button onClick={() => {this.setState({toRegister: true})}} className="button button-block button-dark activated"><i className="fa fa-user-plus" aria-hidden="true"></i> Sign Up</button>
            </div>
          </div>
        </div>
